...
const routes: Routes = [
  ...
  { path: 'por-categoria', loadChildren: './pages/por-categoria/por-categoria.module#PorCategoriaPageModule' },
  { path: 'por-subtipo/:id', loadChildren: './pages/por-subtipo/por-subtipo.module#PorSubtipoPageModule' },
